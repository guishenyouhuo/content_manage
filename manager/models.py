...
class AutoMessage(models.Model):
    # 当前分配
    cur_user = models.ForeignKey(UserProfile, to_field='user_num', related_name='cur_user', on_delete=models.DO_NOTHING)
...
class TagMapping(models.Model):
    ...
    ref_template = models.ForeignKey(MsgTemplate, to_field='template_key', related_name='ref_template',
